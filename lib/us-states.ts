// Canonical list of the 50 US states (plus DC) used for broker licensed-state
// selection. This is the single source of truth for state code/name pairs in
// the application — onboarding, broker profile editing, and admin broker forms
// all use this constant. Stable two-letter codes; never repurpose the broker's
// profile `state` field for license states.
