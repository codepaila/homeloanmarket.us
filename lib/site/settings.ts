...
const DEFAULTS: SiteSettings = {
  ...
  siteDescription: 'Find trusted mortgage brokers in the United States.',
  ...
  seoTitle: 'HomeLoanMarket | Find Trusted Mortgage Brokers in the US',
  seoDescription: 'Compare verified mortgage brokers across the United States, read real reviews, and connect with the right mortgage expert.',
  socialFacebook: null,
  socialTwitter: null,
  socialLinkedIn: null,
  socialInstagram: null,
  socialYouTube: null,
  footerDescription: 'HomeLoanMarket helps home buyers find and compare verified mortgage brokers across the United States.',
