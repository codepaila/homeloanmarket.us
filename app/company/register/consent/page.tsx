...
export default function CompanyRegistrationConsentPage() {
  ...
  const handleContinue = async () => {
    ...
    setError('')
    try {
      // Persist explicit legal consent server-side through the shared consent
      // boundary. Authentication alone is never treated as consent; the server
      // independently requires both agreements to be true.
      ...
      router.replace('/company/register/continue')
    } catch (cause) {
  ...
  return (
    <AuthFormWrapper
      title="Company Registration — Legal Agreement"
      subtitle="Before completing your company account, please confirm your agreement to our terms."
      size="lg"
      showBackLink
      backHref="/company/register"
