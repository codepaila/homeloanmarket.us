// app/broker/profile/personal/page.tsx
...
export default async function PersonalProfilePage() {
  ...
  // Pass an explicit safe DTO to the client component — never the full
  // getCurrentUser() object (which would serialize sensitive relations).
  const profileUser = {
    id: user.id,
    name: user.name,
    email: user.email,
